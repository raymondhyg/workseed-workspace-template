...
发布 `workspace-template-v0.1.4` 前还要额外运行：
...
请不要把 `Core 版本：ws-core-v0.3.1` 理解成“这个 Template 已经能直接使用
...
```powershell
python scripts/utils/install_core_capabilities.py --zip-path "D:\Downloads\workseed-core-runtime-ws-core-v0.3.1-standard-20260704.zip" --core-version ws-core-v0.3.1
```
